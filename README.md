<div align="center">
  ...
  <p align="center">
    ...
    &nbsp;&nbsp;
    <a href="https://github.com/ViktorGabriel" target="_blank">
...
Software Engineering student (6th term) with background in critical process monitoring, root cause troubleshooting, and proactive incident response at **Sitran**. My technical focus is centered on architecting **scalable, distributed backend systems with strict data integrity, fault tolerance, and high availability**.

I apply **Clean Architecture**, **SOLID principles**, **Design Patterns**, and **Automated Testing suites (Unit & Integration)** to deliver decoupled, maintainable code ready for high-throughput environments such as modern fintech platforms.
...
<div align="center">
  <p><i>"A melhor forma de prever o futuro é construí-lo através de código limpo, resiliente e bem estruturado."</i></p>
  <sub>Engenharia de Software focada em impacto, escalabilidade e qualidade contínua.</sub>
</div>
